 ...
 *
 *		情况3		类 :: 非静态方法
 * 5. 方法引用使用的要求：要求接口中的抽象方法的形参列表和返回值类型与方法引用的方法的形参列表和返回值类型相同（针对于情况1和2）
 *
 */
public class MethodRefTest {
    ...
    @Test
    public void test2() {
    	Employee employee = new Employee(10, "James", 34, 3000);
    ...
    public void test4() {
		...
		System.out.println(f1.apply(3.2));
    ...
    @Test
    public void test7() {
		Employee james = new Employee(122, "james", 34, 4000);

		Function<Employee, String> f1 = e -> e.getName();
		System.out.println(f1.apply(james));

		System.out.println("-----------------");

		Function<Employee, String> f2 = Employee::getName;
		System.out.println(f2.apply(james));
	}
